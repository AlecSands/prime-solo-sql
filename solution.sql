...
-- 3. The bank is giving a new customer bonus! Update all
-- records with an account balance of 0.00 and a transactions_attempted of 0.
...
-- balances, sort highest to lowest balance. NOTE: Research LIMIT
...
VALUES ('Alec Sands', 'Minneapolis', 5, 5, '1000.00');
